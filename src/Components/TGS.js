      ...
      <div>
        ...
        <div className="container narrow">
          <div className="content-blob">
            ...
            <p>
              The Great Suspender (TGS) is my friend's Google Chrome extension
              which I designed and generally helped out with. It frees up system
              memory by 'suspending' tabs that haven't been used in a while.
            </p>
            <p>
              It has well over one million active users and has made many
              (many!) people's computers usable again. Some users have reported
              a 40% boost in battery life, and others say it's breathed life
              into laptops that were destined for the trash heap.
            </p>
          </div>
          ...
          <div className="content-blob">
            <h2>What I did</h2>
            <p>
              I thought TGS was a great idea, so I jumped at the chance to make
              it as good as it could be.
            </p>
            <ul>
              <li>I helped figure out what it should/shouldn't do.</li>
              <li>
                Wireframed and experimented with different versions of the
                settings and suspended tab areas.
              </li>
